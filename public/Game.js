...
BunnyDefender.Game.prototype = {
    ...
    checkBunniesLeft: function() {
      if (this.totalBunnies <= 0) {
        ...
        this.overmessage = this.add.bitmapText(this.world.centerX-100, this.world.centerY-40,
    ...
    makeGhost: function(b) {
        bunnyghost = this.add.sprite(b.x-20, b.y-100, 'ghost')
